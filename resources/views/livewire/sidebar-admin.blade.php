            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="{{ url ('dashboardAdmin/userManage') }}"
                        ...
                        <svg class="w-5 h-5 text-gray-500 transition duration-75-white"
                        ...
                        <span class="ms-3">UserManage</span>
                    </a>
                </li>
                <li>
                    <a href="#"
                ...
                <li>
                    <a href="{{ url ('dashboardAdmin/kelolaJadwal') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Kelola Jadwal</span>
                        </a>
                </li>
                <li>
                    <a href="#"
