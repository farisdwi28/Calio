    ...
    <div class="flex flex-row justify-center">
        ...
        <div class="flex flex-col items-start">
            <div class="bg-white max-w-md p-8 rounded-lg shadow-md mb-4 hover:shadow-xl transform hover:scale-105 transition-all duration-300 ease-in-out">
                ...
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Push Up</h2>
            ...
            <div class="bg-white max-w-md p-8 rounded-lg shadow-md mb-4 hover:shadow-xl transform hover:scale-105 transition-all duration-300 ease-in-out">
                ...
                class="w-full h-48 object-cover rounded-md mb-4">
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Sit Up</h2>
            ...
            <div class="bg-white max-w-md p-8 rounded-lg shadow-md mb-4 hover:shadow-xl transform hover:scale-105 transition-all duration-300 ease-in-out">
                ...
                class="w-full h-48 object-cover rounded-md mb-4">
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Pull Up</h2>
                <p class="text-gray-600 mb-4">Pull Up meningkatkan kekuatan tubuh atas, khususnya otot punggung dan bahu.</p>
                <div class="relative z-10 flex flex-col items-center py-5">
                    <livewire:button :buttonText="'Atur'" :buttonAction="'/jadwal'"/>
                </div>
            </div>
        ...
        <div class="flex flex-col items-start">
            ...
            <div class="bg-white max-w-md p-8 rounded-lg shadow-md mb-4 hover:shadow-xl transform hover:scale-105 transition-all duration-300 ease-in-out">
                ...
                class="w-full h-48 object-cover rounded-md mb-4">
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Squat</h2>
            ...
            <div class="bg-white max-w-md p-8 rounded-lg shadow-md mb-4 hover:shadow-xl transform hover:scale-105 transition-all duration-300 ease-in-out">
                ...
                class="w-full h-48 object-cover rounded-md mb-4">
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Plank</h2>
            ...
            <div class="bg-white max-w-md p-8 rounded-lg shadow-md mb-4 hover:shadow-xl transform hover:scale-105 transition-all duration-300 ease-in-out">
                ...
                class="w-full h-48 object-cover rounded-md mb-4">
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Mountain Climbers</h2>
